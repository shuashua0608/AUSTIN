...
def main():
    ...
    file_path = "../RawData/_Video/"+args["Videopath"]+".MOV"
    ...
    out = cv2.VideoWriter('../Feature/Crop/'+args["Videopath"]+'.avi', fourcc, 30.0, (224,224))
    ...
    while success:
        ...
        # if key == ord("q"):
        #     break
        # cv2.imwrite('../Feature/Frames/'+args["Videopath"]+'/'+str(fn)+'.jpg',dst)
        out.write(dst)
        prev_frame = frame
