...
def main():
    ...
    if not os.path.isdir('../Feature/Frames_fix/'+args["Videopath"]):
        os.mkdir('../Feature/Frames_fix/'+args["Videopath"])
    
    if len(os.listdir('../Feature/Frames_fix/'+args["Videopath"])) > 400:
        return
    print(file_path)
    ...
    while success:
        ...
        #     break
        if fn > 6:
            cv2.imwrite('../Feature/Frames_fix/'+args["Videopath"]+'/'+str(fn)+'.jpg',dst)
        # prev_frame = frame
